...
- **편의 장치:** Docker Compose 기반 실행을 한결 손쉽게 명령할 수 있는 전용 [Makefile](file:///home/ejpark/workspace/scraper/apps/ebook/Makefile) 생성.
...
- **도커 연동:** `HOST_PROJECT_PATH` 마운트 싱크를 감안해 `Makefile`을 기동하여 어디서나 정상 바인딩됨.
