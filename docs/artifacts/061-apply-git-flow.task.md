...
### 2단계: 검증 및 동기화
- [ ] 자동 커밋 및 검증: 변경사항 저장 후 `scripts/agents/commit-changes.sh`를 실행하여 개선된 로직이 실제 커밋 메시지를 적절하게 자동 빌드하는지 확인
- [ ] `CHANGELOG.md` 갱신

### 3단계: 보고서 작성
- [ ] 코드 리뷰 문서 (`061-apply-git-flow.review.md`) 작성
- [ ] 결과보고서 (`061-apply-git-flow.walkthrough.md`) 작성
- [ ] `INDEX.md` 및 마일리 갱신 확인 (squash 시 자동 갱신됨)
