...
refresh-urls:
	$(COMPOSE) run --rm $(RUN_USER) -e OVERWRITE=$(OVERWRITE) clipper npx ts-node src/crawler/core/cli-refresh-urls.ts pytorch_kr

refresh-silver:
	$(COMPOSE) run --rm $(RUN_USER) clipper npx ts-node src/crawler/core/cli-refresh-transform.ts pytorch_kr

refresh-silver-rebuild:
	npx ts-node src/crawler/core/cli-refresh-silver.ts pytorch_kr
